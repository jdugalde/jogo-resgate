function start() { // Inicio da funcao start()
    ...
    function gameOver() {
        ...
        $("#fim").html("<h1> Game Over! </h1><p>Pontos: " + pontos + " Salvos: " + salvos + " Perdidos: " + perdidos + "</p>" + "<div id='reinicia' onClick=reiniciaJogo()><h3>JOGAR NOVAMENTE</h3></div>");

    } // Fim da funcaoo gameOver();
